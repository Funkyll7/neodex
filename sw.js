...
const SHELL_FILES = [
  ...
  "./assets/img/logo-maj.png",
  "./assets/img/logo-maj-icone.png",
  "./assets/img/motif-palmes.svg",
  "./assets/img/balls/hyper.svg",
  "./assets/img/balls/lune.svg",
  "./assets/img/balls/master.svg",
];
